...
print(
    "Type a Sentence and I will analyze your sentences "
    "with TextBlob and show you the sentiment."
)
print(
...
while True:
    ...
    if user_input.lower() == "exit":
        print(
            f"{Fore.CYAN}Goodbye, Agent {user_name}! 🌀"
            f"{Style.RESET_ALL}"
        )
        break
        ...
        print(
            f"{Fore.YELLOW}Conversation history has been reset."
            f"{Style.RESET_ALL}"
        )
        continue
        ...
        if not conversation_history:
            ...
            print(
                f"{Fore.CYAN} Conversation History:"
                f"{Style.RESET_ALL}"
            )
